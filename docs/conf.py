...
# -*- coding: utf-8 -*-
#
# Seaworthy documentation build configuration file, created by
...
# built documents.
try:
    from seaworthy import __version__
...
htmlhelp_basename = 'Seaworthydoc'
...
latex_documents = [
    (master_doc, 'Seaworthy.tex', 'Seaworthy Documentation',
     'Jamie Hewland \\& Jeremy Thurgood', 'manual'),
]
...
man_pages = [
    (master_doc, 'seaworthy', 'Seaworthy Documentation',
     [author], 1)
]
